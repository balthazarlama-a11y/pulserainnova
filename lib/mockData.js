...
export const TODAY_ACTIVITY = [
  { time: "07:15", event: "Despertó tranquilo", icon: "sun", color: "#F5D06F" },
  { time: "08:40", event: "Pico leve camino al colegio", icon: "activity", color: "#F59E4C" },
  { time: "10:22", event: "Respiración 4-7-8 completada", icon: "wind", color: "#A8E6CF" },
  { time: "13:05", event: "Almuerzo, muy relajado", icon: "heart", color: "#5EDC9A" },
  { time: "16:30", event: "Minijuego burbujas", icon: "gamepad", color: "#B8A4FF" },
];
