...
export const SIMULATION_WEEK = [
  ...
  // ─── MARTES ─── "Examen de matemáticas"
  {
    ...
    events: [
      ...
      { time: "14:00", hour: 14.0, event: "Minijuego de burbujas", icon: "gamepad", color: "#B8A4FF", stress: 25 },
    ...
    exercises: [
      ...
      { time: "14:00", type: "Minijuego de burbujas", duration: "2 min", mood_before: "mild", mood_after: "calm" },
  ...
  // ─── VIERNES ─── "Último día + fiesta de cumpleaños"
  {
    ...
    events: [
      ...
      { time: "17:30", hour: 17.5, event: "Minijuego de burbujas en la fiesta", icon: "wind", color: "#A8E6CF", stress: 35 },
    ...
    exercises: [
      { time: "17:30", type: "Minijuego de burbujas", duration: "2 min", mood_before: "moderate", mood_after: "mild" },
    ],
    summary: {
      avgStress: 27,
      peakStress: 58,
