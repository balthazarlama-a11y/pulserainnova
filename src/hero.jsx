// HeroGeometric — rotating blurred gradient shapes behind a bold centered headline
...
const HeroGeometric = ({ onPrimary, onSecondary }) => {
  return (
    <section style={{
      ...
      {/* Ambient gradient wash behind shapes */}
      <div style={{
        position: 'absolute', inset: 0,
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span style={{ fontSize: 13, color: 'var(--ink-muted)', letterSpacing: 0.3 }}>CalmBand · Bienestar infantil con IA</span>
        </div>
        ...
        <p style={{
          ...
          La pulsera inteligente que detecta el estrés de tus hijos en tiempo real
          y les enseña a calmarse con ejercicios guiados por IA.
        </p>

        {/* CTAs */}
        <div style={{
          display: 'flex', gap: 14, justifyContent: 'center', flexWrap: 'wrap',
          opacity: 0, animation: 'heroTextIn 0.9s 0.9s forwards'
        }}>
        ...
        <div style={{
          ...
          color: 'var(--ink-faint)',
          fontSize: 13,
          opacity: 0, animation: 'heroTextIn 0.9s 1.1s forwards'
        }}>
          <span style={{ display: 'inline-flex', alignItems: 'center', gap: 8 }}>
            <span style={{ display: 'inline-flex', gap: 2 }}>
              {[0,1,2,3,4].map(i => <IconStar key={i} size={12} style={{ fill: '#F5D06F', color: '#F5D06F' }}/>)}
            </span>
            4.9 en App Store
          </span>
          <span>•</span>
...
Object.assign(window, { HeroGeometric });
