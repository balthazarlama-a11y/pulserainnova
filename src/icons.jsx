// Minimal stroke icons (Lucide-style) — 24x24, stroke=1.75
const Icon = ({ children, size = 20, stroke = 1.75, className = '', style = {} }) => (
...
const IconSparkles = (p) => <Icon {...p}><path d="M12 3l1.9 4.6L18.5 9.5l-4.6 1.9L12 16l-1.9-4.6L5.5 9.5l4.6-1.9L12 3z"/><path d="M19 14l.9 2.1L22 17l-2.1.9L19 20l-.9-2.1L16 17l2.1-.9L19 14z"/></Icon>;
const IconBell = (p) => <Icon {...p}><path d="M18 8a6 6 0 0 0-12 0c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></Icon>;
const IconBrain = (p) => <Icon {...p}><path d="M12 5a3 3 0 0 0-3-3 3 3 0 0 0-3 3 3 3 0 0 0-3 3c0 1.5.5 2.5 2 3-1.5.5-2 1.5-2 3a3 3 0 0 0 3 3 3 3 0 0 0 3 3 3 3 0 0 0 3-3"/><path d="M12 5a3 3 0 0 1 3-3 3 3 0 0 1 3 3 3 3 0 0 1 3 3c0 1.5-.5 2.5-2 3 1.5.5 2 1.5 2 3a3 3 0 0 1-3 3 3 3 0 0 1-3 3 3 3 0 0 1-3-3"/><path d="M12 5v14"/></Icon>;
const IconWatch = (p) => <Icon {...p}><circle cx="12" cy="12" r="6"/><path d="M12 10v2l1.5 1.5"/><path d="M16.5 4.5 16 2H8l-.5 2.5"/><path d="m7.5 19.5.5 2.5h8l.5-2.5"/></Icon>;
...
const IconWind = (p) => <Icon {...p}><path d="M9.59 4.59A2 2 0 1 1 11 8H2m10.59 11.41A2 2 0 1 0 14 16H2m15.73-8.27A2.5 2.5 0 1 1 19.5 12H2"/></Icon>;
...
const IconSmartphone = (p) => <Icon {...p}><rect x="5" y="2" width="14" height="20" rx="2" ry="2"/><line x1="12" y1="18" x2="12.01" y2="18"/></Icon>;
...
const IconCloud = (p) => <Icon {...p}><path d="M18 10h-1.26A8 8 0 1 0 9 20h9a5 5 0 0 0 0-10z"/></Icon>;
...
Object.assign(window, {
  Icon,
  IconHeart, IconActivity, IconShield, IconSparkles, IconBell, IconBrain,
  IconWatch, IconPlay, IconCheck, IconArrowRight, IconArrowLeft, IconX, IconMenu,
  IconLock, IconMail, IconEye, IconHome, IconUser, IconChart, IconSettings,
  IconWind, IconGamepad, IconMusic, IconBook, IconStar, IconSmartphone,
  IconZap, IconMoon, IconSun, IconCloud, IconDroplet, IconLogOut, IconChevronRight
});
